...
<!-- Sidebar end=============================================== -->
		...
		<h4>Latest Products </h4>
			  <ul class="thumbnails">
				<li class="span3">
				  <div class="thumbnail">
					<a  href="product_details_1.php"><img src="themes/images/products/9.jpg" alt=""/></a>
					<div class="caption">
					  <h5>Fujifilm FinePix S2950 Digital </h5>
					  <p> 
						Lorem Ipsum is simply dummy text. 
					  </p>
					 
					  <h4 style="text-align:center"><a class="btn" href="product_details_1.php"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">$222.00</a></h4>
					</div>
				  </div>
				</li>
				...
				<li class="span3">
				  <div class="thumbnail">
					<a  href="product_details_1.php"><img src="<?= $product['image']; ?>" alt="<?= $product['title']; ?>"/></a>
					<div class="caption">
					  <h5><?= $product['title']; ?></h5>
					  <p> 
						<?= $product['description']; ?> 
					  </p>
					 <h4 style="text-align:center"><a class="btn" href="product_details_2.php"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">$<?= $product['price']; ?></a></h4>
					</div>
				  </div>
				</li>
				<?php endwhile; ?>
...
<?php include 'product-details-1.php';
	  include 'product-details-2.php';
	  include 'product-details-3.php';
	  include 'product-details-4.php';
?>
